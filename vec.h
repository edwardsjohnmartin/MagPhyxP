...
union MyVec {
  ...
  NumType operator[](int i) const { return s[i]; }
...
//------------------------------------------------------------
// mult
inline double3 mult(const double3 a, const double3 b) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]*b.s[i];
  return result;
}
inline double3 mult(const double3 a, const double c) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]*c;
  return result;
}
inline double3 mult(const double c, const double3 a) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]*c;
  return result;
}
inline double2 mult(const double2 a, const double2 b) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]*b.s[i];
  return result;
}
inline double2 mult(const double2 a, const double c) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]*c;
  return result;
}
inline double2 mult(const double c, const double2 a) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]*c;
  return result;
}
...
inline double3 add(const double3 a, const double c) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]+c;
  return result;
}
inline double2 add(const double2 a, const double2 b) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]+b.s[i];
  return result;
}
inline double2 add(const double2 a, const double c) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]+c;
  return result;
}
//------------------------------------------------------------
// subtract
inline double3 subtract(const double3 a, const double3 b) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]-b.s[i];
  return result;
}
inline double3 subtract(const double3 a, const double c) {
  double3 result;
  for (int i = 0; i < 3; i++) result[i] = a.s[i]-c;
  return result;
}
inline double2 subtract(const double2 a, const double2 b) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]-b.s[i];
  return result;
}
inline double2 subtract(const double2 a, const double c) {
  double2 result;
  for (int i = 0; i < 2; i++) result[i] = a.s[i]-c;
  return result;
}
...
inline double3 normalized(const double3 v) {
  return v / length(v);
}
